...
<html>
    ...
    <body>
        ...
        int idPac = (int)(miSessiondelUsuario.getAttribute("idPac"));
        ...
        <nav class="navbar navbar-expand-lg bg-light">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div id="mayones">
                        <a class="btn btn-primary" href="../interfazDatosUsrs.jsp" style="background-color: #87CEEB; border-color: #87CEEB;">
                            Regresar
                        </a>
