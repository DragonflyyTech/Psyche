...
<html>
    <head>
        ...
        try{
            idPac = Integer.parseInt(request.getParameter("idPac"));
            nombPac = request.getParameter("nombPac");
            miSessiondelUsuario.setAttribute("idPac", idPac);
            miSessiondelUsuario.setAttribute("nombPac", nombPac);
            
        } catch(Exception ex){
            idPac = (int)(miSessiondelUsuario.getAttribute("idPac"));
            nombPac = String.valueOf(miSessiondelUsuario.getAttribute("nombPac"));
        }
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div style="margin:10px;">
                        <a class="btn btn-primary" href="principal_d.jsp" style="background-color: #87CEEB; border-color: #87CEEB;">
                            Regresar
                        </a>
                ...
                <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3" id="izq">
                    <div id="gride" class="p-4 centrado">
                        ...
                        <div class="centrado cont_btn">
                            <a class="btn btn-primary" href="Chat.jsp?idPac=<%=idPac%>" role="button" style="background-color: #E1C86B; border-color: #E1C86B; width: 210px;"><h3>Chatear</h3></a>
                        </div>
                        <div class="centrado cont_btn">
                            <a class="btn btn-primary" href="Diario_pac.jsp#?idPac=<%=idPac%>" role="button" style=" background-color: #49ADCF; border-color: #49ADCF; width: 210px;"><h3>Leer diario</h3></a>
                        </div>
                        <div class="centrado cont_btn">
                            <a class="btn btn-primary" href="calendario/index.jsp" role="button" style=" background-color: #74AF9D; border-color: #74AF9D;  width: 210px;"><h3>Citas</h3></a>
                        </div>
                        <div class="centrado cont_btn">
                            <a class="btn btn-primary" href="#?idPac=<%=idPac%>" role="button" style=" background-color: #B2BEC3; border-color: #B2BEC3;  width: 210px;"><h3>Revisar tests</h3></a>
                        </div>
