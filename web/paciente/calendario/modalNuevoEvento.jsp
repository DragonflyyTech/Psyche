<%
    int idDoc = (int) (miSessiondelUsuario.getAttribute("idDoc"));
%>
...
<div class="modal" id="exampleModal"  tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form name="formEvento" id="formEvento" action="nuevoEvento.jsp" class="form-horizontal" method="POST">
                <div class="form-group">
                    <label for="evento" class="col-sm-12 control-label">Nombre de la Cita</label>
                    <div class="col-sm-10">
