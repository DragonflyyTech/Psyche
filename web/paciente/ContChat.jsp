...
<%
        ...
        Base bd = new Base();
        bd.conectar();
        String consulta2 = "select * from tabla_mensaje, doc_pac where tabla_mensaje.id_relacionDP = doc_pac.id_relacionDP and doc_pac.id_pac='" + idPac + "' and doc_pac.id_doc='" + idDoc + "'";
